...
/** Inform Fast Pair Keys about the state of the procedure.
 *
 * The function must be called to allow Personalized Name write in special Fast Pair procedure flow.
 *
 * @param[in] conn	Pointer to Bluetooth connection (determines Fast Pair Seeker).
 *
 * @return 0 If the operation was successful. Otherwise, a (negative) error code is returned.
