 ...
 *
 * Private definitions of the Fast Pair storage of Account Keys module. Used only by the module and
 * by the unit test.
 * @{
 */
...
/** Settings key name prefix for Personalized Name. */
#define SETTINGS_PN_KEY_NAME "pn"

/** String used as a separator in settings keys. */
#define SETTINGS_NAME_SEPARATOR_STR "/"

/** Full settings key name prefix for Personalized Name (including subtree name). */
